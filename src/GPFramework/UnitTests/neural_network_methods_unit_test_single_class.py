...
from GPFramework.data import load_text_data_from_file, load_pickle_from_file
import os
...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        train = load_pickle_from_file(os.path.join(os.path.dirname(__file__), "../../../datasets/4000_mc_eo/train_eo0.npz"))
        test = load_pickle_from_file(os.path.join(os.path.dirname(__file__), "../../../datasets/4000_mc_eo/test_eo0.npz"))
        ...
        self.data.set_datatype('imagedata') 
    ...
    def test_single(self):
        ...
        #llist = nnm.LSTMLayer(100, 8, True, False, llist)
        #llist = nnm.GRULayer(100,  nnm.WeightInitializer.RANDOMUNIFORM,8, True, llist)
       # llist = nnm.GlobalMaxPoolingLayer1D(llist)
        #llist2 = nnm.InputLayer()
        #llist2 = nnm.EmbeddingLayer(100, ARG0, nnm.WeightInitializer.RANDOMUNIFORM, llist2)
        #llist2 = nnm.LSTMLayer(100, 8, True, llist2)
        #llist2 = nnm.GRULayer(100,  nnm.WeightInitializer.RANDOMUNIFORM,8, True, llist2)
        #llist2 = nnm.GlobalAveragePoolingLayer1D(llist2)
        ...
        #llist = nnm.DenseLayer(10, nnm.WeightInitializer.RANDOMUNIFORM,3,llist)
        #llist1 = nnm.InputLayer()
        #llist1 = nnm.DenseLayer(10, nnm.WeightInitializer.RANDOMUNIFORM,3,llist1)
        #llist2 = nnm.InputLayer()
        #llist2 = nnm.DenseLayer(10, nnm.WeightInitializer.RANDOMUNIFORM,3,llist2)
        #llist3 = nnm.ConcatenateLayer(-1, llist, llist1)
        #llist4 = nnm.ConcatenateLayer(-1, llist3, llist2)
        #llist5 = nnm.OutputLayer(ARG0, llist4)


        #print(llist5.mylist)

        #llist = nnm.InputLayer()
        #llist = nnm.EmbeddingLayer(100, ARG0, nnm.PretrainedEmbedding.GLOVE, llist)
        ...
        #llist = nnm.GlobalAveragePoolingLayer1D(llist)
        #llist = nnm.DenseLayer(15,  nnm.WeightInitializer.RANDOMUNIFORM,10, llist)
        #llist = nnm.LeakyReLULayer(0.01, llist)
        #llist = nnm.DropoutLayer(0.1, llist)
        #llist = nnm.DenseLayer(15,  nnm.WeightInitializer.RANDOMUNIFORM,3,llist)
